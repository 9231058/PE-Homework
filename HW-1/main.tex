...
\section{سوال دوم}
متغیر تصادفی زمانی که یک ماشین منتظر می‌ماند را به صورت گسسته مدل می‌کنیم و داریم:
...
\begin{align}
\begin{split}
    E(X) = \sum_{i=0}^{30} i * P(X=i) = \frac{1}{90} * \frac{30 * 31}{2} = \frac{31}{6}
\end{split}
\end{align}
...
مقدار \lr{E[Y|X]}
به مقدار \lr{x} وابسته بوده و یک متغیر تصادفی خواهد بود.
...
برای یافتن مقدار بیشینه تابع درست نمایی نسبت به پارامتر \lr{p}
...
در نهایت با حل رابطه بالا مقدار \lr{p} برابر با \lr{0.5}
بدست می‌آید.
